...
class HomePageTest(TestCase):
    ...
    def test_home_page_renders_home_template(self):
        ...
        self.assertTemplateUsed(response, 'home.html') #Test template

    def test_home_page_uses_item_form(self):
        response = self.client.get('/')
        self.assertIsInstance(response.context['form'], ItemForm) # check view uses the right form
...
class NewListViewIntegratedTest(TestCase):
    ...
    def test_saving_a_POST_request(self):
        ...
        self.assertEqual(Item.objects.count(), 1) # check that one new item has been to the database
        new_item = Item.objects.first()
        self.assertEqual(new_item.text, 'A new list item') # check that the items' text is correct
    ...
    def test_saves_list_owner_if_user_is_logged_in(self):
        request = HttpRequest()
